    ...
    #+BEGIN_SRC yaml
      - :id: my_releasable
        :revision:
          ...
          :comment_prefix: "#"
        # Sequence of build steps -- each item should be a valid shell command
        :build_steps:
          - bundle exec rake install
        # Sequence of artefacts to package in the release archive.
        # The revision archive will also include the revision history extracted as a text file
        :artefacts:
          # A binary artefact -- the <VER> (or <REV>) placeholders wil be replaced with the current revision ID
...
**** TODO add support for overridable defaults
